...
public class QuickSortSubListTest {
    ...
    private final SortSubList<String, List<String>> listSort = new QuickSort<>();
    private final SortSubList<String, PersistentList<String>> plistSort = new QuickSort<>();

    private final SortSubList<String, TransientList<String>> tlistSort = new QuickSort<>();
    ...
    private final SortSubList<Integer, List<Integer>> intListSort = new QuickSort<>();
    private final SortSubList<Integer, PersistentList<Integer>> intPlistSort = new QuickSort<>();

    private final SortSubList<Integer, TransientList<Integer>> intTlistSort = new QuickSort<>();
